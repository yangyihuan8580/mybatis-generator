...
public class CodeResourceUtil
{
  ...
  public static String URL = "jdbc:mysql://127.0.0.1:3306/zhcrm?useUnicode=true&characterEncoding=UTF-8";

  public static String USERNAME = "root";

  public static String PASSWORD = "root";

  public static String DATABASE_NAME = "zhcrm";
 ...
 // public static String page_package = "page";
  ...
  public static boolean IS_CANCEL_FIRST = false;
  ...
  static
  {
    ...
    IS_CANCEL_FIRST = getCanCelFirst();
  }
  ...
  private static boolean getCanCelFirst() {
	  String canceltag = bundlePath.getString("is_cancel_first_name");
	  if(canceltag == null || canceltag.equalsIgnoreCase("no")){
		  return false;
	  }else if(canceltag.equalsIgnoreCase("yes")){
		  return true;
	  }
	return false;
}
